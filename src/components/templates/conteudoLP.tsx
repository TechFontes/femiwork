...
<div className="w-full bg-white">
    ...
    <div className="w-full flex flex-col items-center justify-center gap-10 pt-10 md:pt-20 pb-6">
        ...
        <div className="flex px-5 flex-wrap justify-center gap-5">
            <div className="flex flex-col gap-3 pb-4 max-w-lg">
                ...
                <div className="flex items-center">
                    ...
                    <h2>
                    6 encontros presenciais &#40;1 por mês&#41;, com muita conexão, fé, autoconhecimento e desenvolvimento além de rodadas de network;
                    </h2>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <h2>
                        6 encontros online &#40;1 por mês&#41; com feedbacks de desempenho e de solução de dúvidas entre as filiadas sobre os temas desenvolvidos no encontro presencial;
                    </h2>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <h2>
                        Face to face &#40;encontros com outras filiadas para poder estreitar os laços e  gerar novas parcerias ou venda do seu produto ou serviço, bem como poder ser indicada por elas&#41;;
                    </h2>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <h2>
                        Divulgação do seu trabalho em nosso Instagram e na nossa página;
                    </h2>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <h2>
                        Desconto em workshops e imersão;
                    </h2>
                </div>
            ...
            <div className="flex flex-col gap-3 py-4 max-w-lg">
                ...
                <div className="flex items-center">
                    ...
                    <h2>
                        3 encontros presenciais &#40;1 por mês&#41; , com muita conexão, fé, autoconhecimento e desenvolvimento, além de rodadas de network;
                    </h2>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <h2>
                    3 encontros online &#40;1 por mês&#41; com feedbacks de desempenho e de solução de dúvidas entre as filiadas sobre os temas desenvolvidos no encontro presencial;
                    </h2>
                </div>
                ...
                <div className="flex items-center">
                    ...
                    <h2>
                        Divulgação do seu trabalho em nosso Instagram;
                    </h2>
                </div>
