...
export default function LandpageRodape() {  
...
<div className="w-full border-t-2 border-[#e97464]/80 shadow-y">
    <div className="grid justify-items-center">
    <div className='md:pt-7 px-2 pb-4 max-w-7xl'>

        <div className='grid md:grid-cols-2 md:gap-44'>

            
            <div className='mt-10 md:mt-0 md:mb-0 mb-7'>
                
                <div className='flex justify-center text-center text-xl'>
                    <h6>Acompanhe em nossas redes sociais</h6>
                </div>
                
                <div className='flex justify-center gap-4 mt-4'>

                    <div className='scale-95 border p-1.5 rounded-md border-[#EB6B59] text-[#EB6B59] hover:text-white hover:bg-[#EB6B59] cursor-pointer hover:scale-105 transition-all'>
